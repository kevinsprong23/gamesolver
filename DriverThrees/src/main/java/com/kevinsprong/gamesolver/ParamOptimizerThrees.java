...
public class ParamOptimizerThrees {
    public static void main( String[] args ) throws IOException {
    	// out file location
    	String resultsFilePath = "ParameterSearchThreesInitial4.csv";
    	
    	// num sims per parameter setting
    	int numTrials = 10;
    	
    	// sim parameters
    	double [] monoRange =  {1.5, 2.01, 0.5};
    	double [] smoothRange =  {5, 6.01, 0.5};
    	double [] checkerRange = {0, 0, 0.1};
    	double [] openRange =  {2.0, 2.5, 0.5};
